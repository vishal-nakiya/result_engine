...
const DEFAULT_RULES = [
  ...
  { ruleKey: "pst.height.maleUrCm", value: 170, description: "Male UR height (cm)", isActive: true },
  { ruleKey: "pst.height.femaleUrCm", value: 157, description: "Female UR height (cm)", isActive: true },
  { ruleKey: "pst.height.stMaleCm", value: 162.5, description: "ST male height (cm) (excluding NE ST sub-category)", isActive: true },
  { ruleKey: "pst.height.neStatesMalePolicy", value: "NORM", description: "NE states male height standard policy label", isActive: true },
  { ruleKey: "pst.height.gtaMaleCm", value: 157, description: "GTA (Darjeeling) male height (cm)", isActive: true },
  { ruleKey: "pst.chest.maleUnexpandedMinCm", value: 80, description: "Male chest unexpanded minimum (cm)", isActive: true },
  { ruleKey: "pst.chest.expansionMinCm", value: 5, description: "Chest minimum expansion (cm)", isActive: true },
  { ruleKey: "pet.race.maleStandard", value: "5km/24m", description: "PET race male standard (outside Ladakh)", isActive: true },
  { ruleKey: "pet.race.femaleStandard", value: "1.6km/8.5m", description: "PET race female standard (outside Ladakh)", isActive: true },
  { ruleKey: "pst.chest.femalePolicy", value: "VISUAL", description: "Female chest policy label", isActive: true },

  // --- Special Provisions (UI reference + config) ---
  { ruleKey: "special.pwdPolicy", value: "REJECT", description: "PwD policy action", isActive: true },
  { ruleKey: "special.esmPstPetPolicy", value: "EXEMPT", description: "ESM PST/PET exemption policy", isActive: true },
  { ruleKey: "special.esmQuotaPercent", value: "10%", description: "ESM quota percent per category", isActive: true },
  { ruleKey: "special.pregnancyTuPolicy", value: "TU", description: "Pregnancy temporary unfit policy code", isActive: true },
  { ruleKey: "special.areaAllocationSequence", value: "SEQ", description: "Area allocation sequence policy", isActive: true },
  { ruleKey: "special.debarredDbCheck", value: "ACTIVE", description: "Debarred DB check policy", isActive: true },
  { ruleKey: "special.ssfAllIndia", value: "ALL-IN", description: "SSF all-India basis marker", isActive: true },
  { ruleKey: "special.domicileMismatchAction", value: "CANCEL", description: "Domicile mismatch action", isActive: true },
