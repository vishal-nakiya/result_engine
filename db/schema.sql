...
CREATE TABLE IF NOT EXISTS candidates (
  ...
  ncc_cert text,
  marks_cbe numeric,
  normalized_marks numeric,
  part_a_marks numeric,
  part_b_marks numeric,
  part_c_marks numeric,
  part_d_english_marks numeric,
  part_d_hindi_marks numeric,
  ncc_bonus_marks numeric,
